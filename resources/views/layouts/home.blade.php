    ...
    <body>
        ...
        <div class="layout-container">
            ...
            <div class="app-brand demo">
                <a href="#" class="app-brand-link"><span class="app-brand-text demo menu-text fw-bolder ms-2">Sneat</span></a>
            ...
            <ul class="menu-inner py-1">
                ...
                <a href="{{ route('admin') }}" class="menu-link"><i class="menu-icon tf-icons bx bx-home-circle"></i><div>Dashboard</div></a>
                </li>
                ...
                <a href="{{ Route::has('warehouses.index') ? route('warehouses.index') : '#' }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-building-house"></i><div>Warehouses</div>
                </a>
                </li>

                <li class="menu-item {{ request()->routeIs('categories.*') ? 'active' : '' }}">
                <a href="{{ Route::has('categories.index') ? route('categories.index') : '#' }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-grid-alt"></i><div>Categories</div>
                </a>
                </li>
                <li class="menu-item {{ request()->routeIs('suppliers.*') ? 'active' : '' }}">
                    <a href="{{ Route::has('suppliers.index') ? route('suppliers.index') : '#' }}" class="menu-link">
                ...
                <a href="{{ Route::has('stock.index') ? route('stock.index') : '#' }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-package"></i><div>Stock Products</div>
                </a>
                </li>
                <li class="menu-item {{ request()->routeIs('restocks.*') ? 'active' : '' }}">
                <a href="{{ Route::has('restocks.index') ? route('restocks.index') : '#' }}" class="menu-link">
                ...
                <a href="{{ Route::has('transactions.index') ? route('transactions.index') : '#' }}" class="menu-link">
